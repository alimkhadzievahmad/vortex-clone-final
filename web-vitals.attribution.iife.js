var webVitals = (function (t) {
  ...
  const v = new Set(),
    ...
    M = (t) => {
      if ("hidden" === document.visibilityState) {
        ...
        isFinite(y) ||
          ((y = "visibilitychange" === t.type ? t.timeStamp : 0),
  ...
  let B;
  const C = () => (B ? w : (performance.interactionCount ?? 0)),
    O = () => {
  ...
  class I {
    ...
    p;
    v() {
      ((j = C()), (this.l.length = 0), this.h.clear());
    }
    M() {
      const t = Math.min(this.l.length - 1, Math.floor((C() - j) / 50));
      return this.l[t];
    }
    u(t) {
      ...
      i.t = (t) => {
        if (t?.sources?.length) {
          const e = S(t.sources),
            o = e?.node;
          if (o) {
            const t = n.generateTarget?.(o) ?? r(o);
            s.set(e, t);
          }
        }
      };
          ...
          p(() => {
            ...
            const s = a(n, e),
              c = (t) => {
                ...
                s.o > r.value && ((r.value = s.o), (r.entries = s.i), i());
              },
              u = g("layout-shift", c);
            u &&
              ((i = d(t, r, P, n.reportAllChanges)),
              o.onHidden(() => {
                (c(u.takeRecords()), i(!0));
              }),
              f(() => {
      ...
      ((n.m = (t) => {
        ...
        (n.p = (t) => {
          if (!l.get(t)) {
            ...
            if (n) {
              const o = e.generateTarget?.(n) ?? r(n);
              l.set(t, o);
            }
          }
        }));
          ...
          ((t) => {
            ...
            for (const c of t.longAnimationFrameEntries) {
              ...
              for (const t of c.scripts) {
                ...
                if (c < e) continue;
                const f = c - Math.max(e, t.startTime),
                  d = t.duration
                    ? (f / t.duration) * t.forcedStyleAndLayoutDuration
                    : 0;
                ((s += f - d),
                  (a += d),
                  f > u &&
            ...
            const f = t.longAnimationFrameEntries.at(-1),
              d = f ? f.startTime + f.duration : 0;
            (d >= e + n + o && (c = t.nextPaintTime - d),
              i &&
                r &&
                (t.longestScript = {
                  entry: i,
            ...
            const r = a(e, I),
              s = (t) => {
                A(() => {
                  ...
                  e &&
                    e.T !== i.value &&
                    ((i.value = e.T), (i.entries = e.entries), o());
                });
              },
              c = g("event", s, {
                durationThreshold: e.durationThreshold ?? 40,
              });
            ((o = d(t, i, W, e.reportAllChanges)),
              c &&
                ...
                f(() => {
                  (r.v(), (i = m("INP")), (o = d(t, i, W, e.reportAllChanges)));
                })));
          });
        })((e) => {
          const n = b(e);
    ...
    (t.onLCP = (t, e = {}) => {
      ...
      ((t, e = {}) => {
        E(() => {
          ...
          if (c) {
            o = d(t, i, N, e.reportAllChanges);
            const n = p(() => {
                (s(c.takeRecords()), c.disconnect(), o(!0));
              }),
              r = (t) => {
                t.isTrusted &&
                  (A(n), removeEventListener(t.type, r, { capture: !0 }));
              };
      ...
      ((t, e = {}) => {
        ...
        x(() => {
          ...
          r &&
            ...
            i(!0),
            f(() => {
              ((o = m("TTFB", 0)), (i = d(t, o, V, e.reportAllChanges)), i(!0));
            }));
        });
      })((e) => {
        const n = ((t) => {
