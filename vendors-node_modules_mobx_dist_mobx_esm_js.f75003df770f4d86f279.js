...
(self.webpackChunkfederation_clients =
  ...
  ["vendors-node_modules_mobx_dist_mobx_esm_js"],
  {
    "./node_modules/mobx/dist/mobx.esm.js": (e, t, n) => {
      function r(e) {
        for (
      ...
      (n.r(t),
        n.d(t, {
          $mobx: () => z,
          FlowCancellationError: () => pn,
          ObservableMap: () => Or,
          ObservableSet: () => Sr,
          Reaction: () => Tt,
          _allowStateChanges: () => Ye,
          _allowStateChangesInsideComputed: () => Xt,
          _allowStateReadsEnd: () => vt,
          _allowStateReadsStart: () => _t,
          _autoAction: () => Ft,
          _endAction: () => Xe,
          _getAdministration: () => zr,
          _getGlobalState: () => Ot,
          _interceptReads: () => Sn,
          ...
          return (
            ...
            N(e, [
              ...
              },
              {
                key: "diffValue",
                get: function () {
                  return V(this.flags_, e.diffValueMask_) ? 1 : 0;
                },
                set: function (t) {
                  this.flags_ = C(this.flags_, e.diffValueMask_, 1 === t);
                },
              },
            ])
          );
        })();
      ((F.isBeingObservedMask_ = 1),
        (F.isPendingUnobservationMask_ = 2),
        (F.diffValueMask_ = 4));
      var X = S("Atom", F);
      function Y(e, t, n) {
        (void 0 === t && (t = p), void 0 === n && (n = p));
        var r = new F(e);
        return (t !== p && nn(r, t), n !== p && rn(r, n), r);
      }
      var J = {
      ...
      function se(e, t, n, r) {
        ...
        if (
          ...
          i.bound &&
          (!T(e.target_, t) || !An(e.target_[t])) &&
          null === this.extend_(e, t, n, !1)
        )
          return 0;
        if (An(n.value)) return 1;
        var o = le(e, this, 0, n, !1, !1);
        return (u(r, t, o), 2);
      }
      function ue(e, t, n, r) {
        var i,
          o = le(e, this, 0, n, null == (i = this.options_) ? void 0 : i.bound);
      ...
      function ve(e, t) {
        ...
        return (
          (0, t.addInitializer)(function () {
            var t = Pr(this)[z],
              i = B({}, n.options_, { get: e, context: this });
            (i.name || (i.name = "ObservableObject." + r.toString()),
              t.values_.set(r, new et(i)));
          }),
          function () {
            return this[z].getObservablePropValue_(r);
          }
        );
      }
      function de(e, t) {
          ...
          return {
            get: function () {
              return (
                ...
                this[z].getObservablePropValue_(i)
              );
            },
            set: function (e) {
              return (
                o.has(this) || a(this, e),
                this[z].setObservablePropValue_(i, e)
              );
            },
            init: function (e) {
      ...
      function we(e, t, n, r) {
        ...
        if (r !== e.target_ && "function" == typeof n.value)
          return O(n.value)
            ? (null != (s = this.options_) && s.autoBind ? mn.bound : mn).make_(
                e,
                t,
                n,
                r
              )
            : (null != (a = this.options_) && a.autoBind ? Ft.bound : Ft).make_(
                e,
                t,
                n,
                r
      ...
      Object.freeze(ke);
      var xe = de("observable"),
        Ee = de("observable.ref", { enhancer: Q }),
        Pe = de("observable.shallow", {
          enhancer: function (e, t, n) {
            return null == e || Vr(e) || br(e) || wr(e) || kr(e)
              ? e
              : Array.isArray(e)
      ...
      var Me,
        ...
        Ne = a(Ce, {
          box: function (e, t) {
            var n = je(t);
            return new Qe(e, Ve(n), n.name, !0, n.equals);
          },
          array: function (e, t) {
            var n = je(t);
            return (!1 === mt.useProxies || !1 === n.proxy ? Hr : lr)(
              e,
              Ve(n),
              n.name
            );
          ...
          map: function (e, t) {
            var n = je(t);
            return new Or(e, Ve(n), n.name);
          },
          set: function (e, t) {
            var n = je(t);
            return new Sr(e, Ve(n), n.name);
          },
        ...
        Le = "computed",
        Be = fe(Le),
        Ie = fe("computed.struct", { equals: J.structural }),
        Ue = function (e, t) {
          if (W(t)) return Be.decorate_20223_(e, t);
          if (g(t)) return H(e, t, Be);
          if (m(e)) return q(fe(Le, e));
          var n = m(t) ? t : {};
          return ((n.get = e), n.name || (n.name = e.name || ""), new et(n));
        };
      (Object.assign(Ue, Be), (Ue.struct = q(Ie)));
      var Ke = 0,
        Ge = 1,
        qe =
          null !=
      ...
      function Fe(e, t, n, r) {
        var i = mt.trackingDerivation,
          o = !t || !i;
        jt();
        var a = mt.allowStateChanges;
        o && (ft(), (a = Je(!0)));
        var s = {
          runAsAction_: o,
          prevDerivation_: i,
          prevAllowStateChanges_: a,
          prevAllowStateReads_: _t(!0),
          notifySpy_: !1,
          startTime_: 0,
          actionId_: Ge++,
          parentActionId_: Ke,
        };
        return ((Ke = s.actionId_), s);
      }
      function Xe(e) {
        (Ke !== e.actionId_ && r(30),
      ...
      var Qe = (function (e) {
          ...
          return (
            ...
            (n.prepareNewValue_ = function (e) {
              if ($n(this)) {
                var t = Zn(this, { object: this, type: sr, newValue: e });
      ...
      function at(e) {
        switch (e.dependenciesState_) {
          ...
          case tt.POSSIBLY_STALE_:
            for (
              var t = _t(!0), n = ft(), r = e.observing_, i = r.length, o = 0;
              o < i;
              o++
            ) {
              var a = r[o];
              if (rt(a)) {
                if (mt.disableErrorBoundaries) a.get();
                else
                  try {
                    a.get();
                  } catch (e) {
                ...
                if (e.dependenciesState_ === tt.STALE_)
                  return (ht(n), vt(t), !0);
              }
            }
            return (dt(e), ht(n), vt(t), !1);
        }
      }
      function st() {
        ...
        return (
          ...
          (function (e) {
            for (
              ...
              var s = n[a];
              (0 === s.diffValue &&
                ((s.diffValue = 1), i !== a && (n[i] = s), i++),
                s.dependenciesState_ > r && (r = s.dependenciesState_));
            }
            for (n.length = i, e.newObserving_ = null, o = t.length; o--; ) {
              var u = t[o];
              (0 === u.diffValue && St(u, e), (u.diffValue = 0));
            }
            for (; i--; ) {
              var c = n[i];
              1 === c.diffValue && ((c.diffValue = 0), At(c, e));
            }
            r !== tt.UP_TO_DATE_ &&
      ...
      function wt() {
        var e = new bt();
        for (var t in e) -1 === pt.indexOf(t) && (mt[t] = e[t]);
        mt.allowStateChanges = !mt.enforceActions;
      }
      function At(e, t) {
        (e.observers_.add(t),
      ...
      function Et(e) {
        ...
        return null !== t
          ? (t.runId_ !== e.lastAccessedBy_ &&
            ...
            e.isBeingObserved)
          : (0 === e.observers_.size && mt.inBatch > 0 && kt(e), !1);
      }
      function Pt(e) {
        e.lowestObserverState_ !== tt.STALE_ &&
          ((e.lowestObserverState_ = tt.STALE_),
      ...
      var Tt = (function () {
        ...
        return (
          ...
          (t.schedule_ = function () {
            this.isScheduled ||
              ((this.isScheduled = !0), mt.pendingReactions.push(this), Mt());
          }),
          (t.runReaction_ = function () {
            if (!this.isDisposed) {
              (jt(), (this.isScheduled = !1));
              var e = mt.trackingContext;
              if (((mt.trackingContext = this), at(this))) {
      ...
      function Rt(e) {
        return (
          mt.globalReactionErrorHandlers.push(e),
          function () {
            var t = mt.globalReactionErrorHandlers.indexOf(e);
            t >= 0 && mt.globalReactionErrorHandlers.splice(t, 1);
          }
        );
      }
      ...
      function Mt() {
        mt.inBatch > 0 || mt.isRunningReactions || Ct(Dt);
      }
      function Dt() {
      ...
      var Bt = "action",
        ...
        Ut = "<unnamed action>",
        Kt = te(Bt),
        Gt = te("action.bound", { bound: !0 }),
        qt = te(It, { autoAction: !0 }),
        Ht = te("autoAction.bound", { autoAction: !0, bound: !0 });
      function Wt(e) {
        return function (t, n) {
          return b(t)
            ? We(t.name || Ut, t, e)
            : b(n)
              ? We(t, n, e)
              : W(n)
                ? (e ? qt : Kt).decorate_20223_(t, n)
                : g(n)
                  ? H(t, n, e ? qt : Kt)
                  : g(t)
                    ? q(te(e ? It : Bt, { name: t, autoAction: e }))
                    : void 0;
        };
      }
      var zt = Wt(!1);
      ...
      (Object.assign(Ft, qt), (zt.bound = q(Gt)), (Ft.bound = q(Ht)));
      var $t = function (e) {
        return e();
      };
      function Qt(e) {
      ...
      function cn(e) {
        ...
        if (
          (void 0 !== i &&
            (mt.useProxies =
              i === sn || (i !== an && "undefined" != typeof Proxy)),
          "ifavailable" === i && (mt.verifyProxies = !0),
          void 0 !== a)
        ) {
          var s = a === sn ? sn : a === un;
          ((mt.enforceActions = s),
            (mt.allowStateChanges = !0 !== s && s !== sn));
        }
        ([
          "computedRequiresReaction",
          "reactionRequiresObservable",
      ...
      var gn = ae("flow"),
        yn = ae("flow.bound", { bound: !0 }),
        mn = Object.assign(function (e, t) {
          if (W(t)) return gn.decorate_20223_(e, t);
          if (g(t)) return H(e, t, gn);
          var n = e,
      ...
      function Sn(e, t, n) {
        var r;
        return (
          wr(e) || br(e) || Ze(e) ? (r = zr(e)) : Vr(e) && (r = zr(e, t)),
      ...
      function kn(e, t, n) {
        return b(n)
          ? (function (e, t, n) {
              return zr(e, t).intercept_(n);
            })(e, t, n)
          : (function (e, t) {
              return zr(e).intercept_(t);
            })(e, t);
      }
      function jn(e, t) {
      ...
      function Pn(e, t) {
        return (
          !!e &&
          (void 0 !== t
            ? !!Vr(e) && e[z].values_.has(t)
            : Vr(e) || !!e[z] || X(e) || Nt(e) || rt(e))
        );
      }
      function Tn(e) {
        return Pn(e);
      ...
      function In(e, t, n) {
        if (Vr(e)) return e[z].defineProperty_(t, n);
        r(39);
      }
      function Un(e) {
        if (Vr(e)) return e[z].ownKeys_();
        r(38);
      }
      function Kn(e, t, n, r) {
        return b(n)
          ? (function (e, t, n, r) {
              return zr(e, t).observe_(n, r);
            })(e, t, n, r)
          : (function (e, t, n) {
              return zr(e).observe_(t, n);
            })(e, t, n);
      }
      function Gn(e, t, n) {
        return (e.set(t, n), n);
      ...
      function qn(e, t) {
        if (null == e || "object" != typeof e || e instanceof Date || !Tn(e))
          return e;
        if (Ze(e) || rt(e)) return qn(e.get(), t);
        ...
        return (
          Un(e).forEach(function (n) {
            c.propertyIsEnumerable.call(e, n) && (o[n] = qn(e[n], t));
          }),
          o
        );
      }
      ...
      function Xn(e, t, n) {
        ...
        var o = We("When-effect", t),
          a = Jt(function (t) {
            Ye(!1, e) && (t.dispose(), r && clearTimeout(r), o());
          }, n);
        return a;
      }
      function Yn(e) {
      ...
      var Jn = {
        ...
        set: function (e, t, n) {
          var r;
          return !!g(t) && (null == (r = Yn(e).set_(t, n, !0)) || r);
        },
        deleteProperty: function (e, t) {
          var n;
          return !!g(t) && (null == (n = Yn(e).delete_(t, !0)) || n);
        },
        ...
        return m(e)
          ...
          : (Xr(function () {
              ...
              if (!e[ir]) {
                ...
                (o.delete("constructor"), o.delete(z), w(i, ir, o));
              }
      ...
      (hr("at", _r),
        ...
        hr("reduce", dr),
        hr("reduceRight", dr));
      var pr = S("ObservableArrayAdministration", cr);
      function br(e) {
        return y(e) && pr(e[z]);
      }
      var gr = {},
        ...
        Or = (function () {
          function e(e, t, n) {
            ...
            (void 0 === t && (t = $),
              ...
              b(Map) || r(18),
              Xr(function () {
                ((i.keysAtom_ = Y("ObservableMap.keys()")),
                  (i.data_ = new Map()),
                  (i.hasMap_ = new Map()),
                  e && i.merge(e));
              }));
          ...
          return (
            ...
            (t.delete = function (e) {
              ...
              if (
                (this.keysAtom_,
                $n(this) && !Zn(this, { type: mr, object: this, name: e }))
              )
                return !1;
              if (this.has_(e)) {
                var n = er(this),
        ...
        Sr = (function () {
          function e(e, t, n) {
            ...
            (void 0 === t && (t = $),
              ...
              Xr(function () {
                ((i.atom_ = Y(i.name_)), e && i.replace(e));
              }));
          }
          var t = e.prototype;
          return (
            ...
            (t.add = function (e) {
              ...
              if (
                (this.atom_,
                $n(this) && !Zn(this, { type: yr, object: this, newValue: e }))
              )
                return this;
              if (!this.has(e)) {
                zn(function () {
            ...
            (t.delete = function (e) {
              ...
              if (
                $n(this) &&
                !Zn(this, { type: mr, object: this, oldValue: e })
              )
                return !1;
              if (this.has(e)) {
                var n = er(this),
            ...
            (t.union = function (e) {
              return j(e) && !kr(e) ? e.union(this) : new Set(this).union(e);
            }),
            ...
            (t.make_ = function (e, t) {
              if ((!0 === t && (t = this.defaultAnnotation_), !1 !== t)) {
                if (!(e in this.target_)) {
                  var n;
                  if (null != (n = this.target_[G]) && n[e]) return;
      ...
      var Tr = S("ObservableObjectAdministration", Er);
      function Rr(e) {
        return (
          jr[e] ||
          (jr[e] = {
      ...
      ((Mr = Ir),
        ...
        Object.setPrototypeOf
          ? Object.setPrototypeOf(Mr.prototype, Dr)
          : void 0 !== Mr.prototype.__proto__
            ? (Mr.prototype.__proto__ = Dr)
            : (Mr.prototype = Dr));
      var Ur = (function (e) {
        function t(t, n, r, i) {
          var o;
          return (
            ...
            Xr(function () {
              ...
              ((e.proxy_ = o),
                ...
                Lr && Object.defineProperty(o, "0", Nr));
            }),
            o
          );
        }
      ...
      function Gr(e) {
        u(Ur.prototype, "" + e, Kr(e));
      }
      function qr(e) {
        if (e > Br) {
          for (var t = Br; t < e + 100; t++) Gr(t);
          Br = e;
        }
      }
      function Hr(e, t, n) {
      ...
      function Wr(e, t) {
        if ("object" == typeof e && null !== e) {
          if (br(e)) return (void 0 !== t && r(23), e[z].atom_);
          ...
          if (X(e) || rt(e) || Nt(e)) return e;
        } else if (b(e) && Nt(e[z])) return e[z];
        r(28);
      }
      function zr(e, t) {
        return (
      ...
      function $r(e, t, n, r, i) {
        ...
        if ((r.push(e), i.push(t), s)) {
          ...
          for (; l--; ) if (!$r(e[l], t[l], n - 1, r, i)) return !1;
        } else {
          var f,
            h = Object.keys(e);
          if (((l = h.length), Object.keys(t).length !== l)) return !1;
          for (; l--; )
            if (!T(t, (f = h[l])) || !$r(e[f], t[f], n - 1, r, i)) return !1;
        }
