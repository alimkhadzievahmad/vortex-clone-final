...
def get_game_settings_data():
    return {
        ...
        # Красное кольцо (Symbol3) - самые частые, но низкие множители
        "Symbol3": [1.5, 2.0, 2.5, 3.0, 4.0, 6.0, 8.0, 11.0, 14.0, 17.0, 22.0, 28.0],

        # Зеленое кольцо (Symbol2) - средние по частоте и значению множители
        "Symbol2": [1.8, 2.5, 3.5, 4.5, 6.5, 9.0, 12.0, 16.0, 20.0, 27.0, 35.0, 50.0],

        # Синее кольцо (Symbol1) - редкие, но самые высокие множители
