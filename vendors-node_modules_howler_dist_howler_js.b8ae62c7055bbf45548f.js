/*! For license information please see vendors-node_modules_howler_dist_howler_js.b8ae62c7055bbf45548f.js.LICENSE.txt */
(self.webpackChunkfederation_clients =
  self.webpackChunkfederation_clients || []).push([
  ["vendors-node_modules_howler_dist_howler_js"],
  {
    "./node_modules/howler/dist/howler.js": (e, n, t) => {
      var o;
      (!(function () {
        "use strict";
        var r = function () {
            ...
            if (
              ...
              for (var t = 0; t < n._howls.length; t++)
                if (!n._howls[t]._webAudio)
                  for (
                    var o = n._howls[t]._getSoundIds(), r = 0;
                    r < o.length;
                    r++
                  ) {
        ...
        i.prototype = {
                  ...
                  try {
                    ...
                    if (
                      ...
                      (o instanceof Promise || "function" == typeof o.then)
                        ...
                        : n ||
                          ((t._playLock = !1), f(), t._emit("play", u._id)),
                      (m.playbackRate = u._rate),
                      m.paused)
                    )
                      return void t._emit(
          ...
          rate: function () {
            ...
            for (var i = 0; i < n.length; i++)
              if ((t = o._soundById(n[i]))) {
                (o.playing(n[i]) &&
                  ((t._rateSeek = o.seek(n[i])),
                  (t._playStart = o._webAudio
                    ? a.ctx.currentTime
                    : t._playStart)),
                  (t._rate = e),
                ...
                var u = o.seek(n[i]),
                  d =
                    (1e3 *
                      ((o._sprite[t._sprite][0] + o._sprite[t._sprite][1]) /
                        1e3 -
                        u)) /
                    Math.abs(t._rate);
                ((!o._endTimers[n[i]] && t._paused) ||
                  (o._clearTimer(n[i]),
              ...
              (0 === o.length
                ...
                : 1 === o.length
                  ? t._getSoundIds().indexOf(o[0]) >= 0
                    ? (n = parseInt(o[0], 10))
                    : t._sounds.length &&
                      ((n = t._sounds[0]._id), (e = parseFloat(o[0])))
                  : 2 === o.length &&
          ...
          on: function (e, n, t, o) {
            ...
            return (
              "function" == typeof n &&
                r.push(o ? { id: t, fn: n, once: o } : { id: t, fn: n }),
              this
            );
          },
          off: function (e, n, t) {
                  ...
                  d = {
                    ...
                    distanceModel:
                      void 0 !== e.distanceModel
                        ...
                        : d.distanceModel,
                    maxDistance:
                      void 0 !== e.maxDistance ? e.maxDistance : d.maxDistance,
                    refDistance:
                      void 0 !== e.refDistance ? e.refDistance : d.refDistance,
                    rolloffFactor:
