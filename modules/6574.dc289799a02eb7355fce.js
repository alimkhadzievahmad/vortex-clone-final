          ...
          var e = {
                      ...
                      (s = [
                              ...
                              (o.onreadystatechange = function () {
                                if (4 === o.readyState)
                                  if (200 === o.status) {
                                    ...
                                    t && i({ data: e, status: 200 });
                                  } else
                                    (u._log(
                                      "wrong status code in AJAX response",
                                      o.status
                                    ),
                                      i({ status: o.status, data: null }));
                              }),
                              setTimeout(function () {
                                return o.send(JSON.stringify(r));
                              }, 20),
                              o
                            );
                          },
                        ...
                        },
                        {
                          ...
                          value: function (e) {
                            if (!this._formatOverride(e)) {
                              ...
                              ((this._binary = !1),
                                (this._methodType = i.JsonMethodType),
                                (this._pushType = i.JsonPushType),
                                (this._encoder = new i.JsonEncoder()),
                                (this._decoder = new i.JsonDecoder()));
                            }
                          },
                        },
                        {
                          ...
                          value: function (e) {
                            ...
                            for (var r in ((this._callbacks = {}), this._subs))
                              if (this._subs.hasOwnProperty(r)) {
                                ...
                                e
                                  ? (i._isSuccess() &&
                                      (i._triggerUnsubscribe(),
                                      (i._recover = !0)),
                                    i._shouldResubscribe() &&
                                      i._setSubscribing())
                                  : i._setUnsubscribed();
                              }
                              ...
                              for (var t in e) {
                                ...
                                if (n in this._callbacks) {
                                  ...
                                  (clearTimeout(this._callbacks[n].timeout),
                                    ...
                                    (0, s.errback)({
                                      error: this._createErrorObject(_, 0),
                                    }));
                                }
                              }
                              return !1;
                          ...
                          value: function () {
                            ...
                            ((this._transport.onopen = function () {
                              ...
                              for (var r in e._serverSubs)
                                if (
                                  e._serverSubs.hasOwnProperty(r) &&
                                  e._serverSubs[r].recoverable
                                ) {
                                  s = !0;
                                  var i = { recover: !0 };
                                  (e._serverSubs[r].seq || e._serverSubs[r].gen
                                    ? (e._serverSubs[r].seq &&
                                        (i.seq = e._serverSubs[r].seq),
                                      e._serverSubs[r].gen &&
                                        (i.gen = e._serverSubs[r].gen))
                                    : e._serverSubs[r].offset &&
                                      (i.offset = e._serverSubs[r].offset),
                                    e._serverSubs[r].epoch &&
                                      (i.epoch = e._serverSubs[r].epoch),
                                    (n[r] = i));
                                }
                              (s &&
                                (t.params || (t.params = {}),
                              ...
                              (this._transport.onclose = function (t) {
                                ...
                                if (t && "reason" in t && t.reason)
                                  try {
                                    ...
                                    (e._debug("reason is an advice object", r),
                                      (n = r.reason),
                                      (s = r.reconnect));
                                  } catch (s) {
                                    ((n = t.reason),
                                ...
                                if (
                                  ...
                                  e._reconnecting = !0;
                                  var i = e._getRetryInterval();
                                  (e._debug(
                                    "reconnect after " + i + " milliseconds"
                                  ),
                                    setTimeout(function () {
                                      !0 === e._reconnect &&
                                        (e._refreshRequired
                        ...
                        },
                        {
                          ...
                          value: function (e, t) {
                            var n = { data: t };
                            "" !== e && (n.method = e);
                            var s = { method: this._methodType.RPC, params: n };
                            return this._methodCall(s, function (e) {
                              return e;
                            });
                          },
                        },
                        {
                          ...
                          value: function (e) {
                            ...
                            return this.isConnected() &&
                              ...
                              ? Promise.resolve({})
                              : Promise.reject(this._createErrorObject(_, 0));
                          },
                        },
                        {
                        ...
                        },
                        {
                          ...
                          value: function (e) {
                            ...
                            ((this._dispatchPromise =
                              this._dispatchPromise.then(function () {
                                var e;
                                ((t._dispatchPromise = new Promise(function (
                                  t
                                ) {
                                  e = t;
                                })),
                          ...
                          value: function (e, t) {
                            ...
                            if (
                              ...
                              if (
                                ...
                                for (var s in this._serverSubs)
                                  this._serverSubs.hasOwnProperty(s) &&
                                    this.emit("unsubscribe", { channel: s });
                              ...
                              var n = this._clientID,
                                ...
                                r = function (r) {
                                  if (
                                    ...
                                    var i = {};
                                    if (r.data.channels)
                                      for (var o in r.data.channels) {
                                        var u = r.data.channels[o];
                                        u.channel && (i[u.channel] = u.token);
                                      }
                                    var a = i[e];
                                    if (a) {
                                      var c = {
                                        method: t._methodType.SUB_REFRESH,
                                        params: { channel: e, token: a },
                                      };
                                      null !== t._getSub(e) &&
                                        t._call(c).then(
                                          function (n) {
                                ...
                                i = { client: this._clientID, channels: [e] };
                              if (null !== this._config.onPrivateSubscribe)
                                this._config.onPrivateSubscribe({ data: i }, r);
                              else {
                                var o = this._ajax(
                        ...
                        },
                        {
                          ...
                          value: function (e, t) {
                            ...
                            if (
                              ...
                              var s = Math.round(1e3 * Math.random()),
                                r = setTimeout(function () {
                                  return n._subRefresh(e);
                                }, this._config.subRefreshInterval + s);
                        ...
                        },
                        {
                          ...
                          value: function (e, t) {
                            ...
                            var s = e.channel;
                            if (
                              (s in this._subs || (this._subs[s] = e),
                              this.isConnected())
                            ) {
                              e._setSubscribing(t);
                              var r = {
                              ...
                              if (
                                (e._subscribeData &&
                                  (r.params.data = e._subscribeData),
                                (0, o.startsWith)(
                                  s,
                                ...
                                this._isSubscribeBatching
                                  ? (this._privateChannels[s] = !0)
                                  : (this.startSubscribeBatching(),
                                    this._subscribe(e),
                                    this.stopSubscribeBatching());
                              else {
                                var i = e._needRecover();
                                if (!0 === i) {
                                  r.params.recover = !0;
                                  var u = this._getLastSeq(s),
                                    a = this._getLastGen(s);
                                  if (u || a)
                                    (u && (r.params.seq = u),
                                      a && (r.params.gen = a));
                                  else {
                                    var c = this._getLastOffset(s);
                                    c && (r.params.offset = c);
                                  }
                                  var h = this._getLastEpoch(s);
                                  h && (r.params.epoch = h);
                                }
                                this._call(r).then(
                                  function (e) {
                        ...
                        },
                        {
                          ...
                          value: function (e, t) {
                            ...
                            if (
                              ...
                              for (var r in (null !== this._latencyStart &&
                                ((this._latency =
                                  new Date().getTime() -
                          ...
                          value: function (e) {
                            for (var t in e)
                              if (e.hasOwnProperty(t)) {
                                ...
                                ((s = this._expandSubscribeContext(s, n)),
                                  this.emit("subscribe", s));
                              }
                            for (var r in e)
                              if (e.hasOwnProperty(r)) {
                                var i = e[r];
                                if (i.recovered) {
                                  var o = i.publications;
                                  if (o && o.length > 0)
                                    for (var u in (o.length > 1 &&
                                      (!o[0].offset ||
                                        o[0].offset > o[1].offset) &&
                                      (o = o.reverse()),
                                    o))
                                      o.hasOwnProperty(u) &&
                                        this._handlePublication(r, o[u]);
                                }
                                this._serverSubs[r] = {
                                  seq: i.seq,
                                  gen: i.gen,
                        ...
                        },
                        {
                          ...
                          value: function (e, t) {
                            ...
                            ("recovered" in t && (n = t.recovered),
                              (e.recovered = n));
                            var s = !1;
                            "positioned" in t && (s = t.positioned);
                            var r = "";
                            "epoch" in t && (r = t.epoch);
                            var i = 0;
                            return (
                              "offset" in t && (i = t.offset),
                              s && (e.streamPosition = { offset: i, epoch: r }),
                        ...
                        },
                        {
                          ...
                          value: function (e, t, n) {
                            ...
                            if (r && r._isSubscribing()) {
                              r._setSubscribeSuccess(n);
                              var i = n.publications;
                              if (i && i.length > 0)
                                for (var o in (i.length >= 2 &&
                                  !i[0].offset &&
                                  !i[1].offset &&
                                  (i = i.reverse()),
                                i))
                                  i.hasOwnProperty(o) &&
                                    this._handlePublication(e, i[o]);
                              if (
                                (!n.recoverable ||
                                  (t && n.recovered) ||
                                ...
                                n.recoverable && (r._recoverable = !0),
                                !0 === n.expires)
                              ) {
                                var u = setTimeout(function () {
                                  return s._subRefresh(e);
                                }, this._getTTLMilliseconds(n.ttl));
                                this._subRefreshTimeouts[e] = u;
                              }
                            }
                          },
                        },
                        ...
                        },
                        {
                          ...
                          value: function (e, t) {
                            ...
                            "type" in n && (s = n.type);
                            var r = n.channel;
                            if (s === this._pushType.PUBLICATION) {
                              var i = this._decoder.decodePushData(
                                this._pushType.PUBLICATION,
                                n.data
                              );
                              this._handlePublication(r, i);
                            } else if (s === this._pushType.MESSAGE) {
                              var o = this._decoder.decodePushData(
                                this._pushType.MESSAGE,
                                n.data
                              );
                              this._handleMessage(o);
                            } else if (s === this._pushType.JOIN) {
                              var u = this._decoder.decodePushData(
                                this._pushType.JOIN,
                                n.data
                              );
                              this._handleJoin(r, u);
                            } else if (s === this._pushType.LEAVE) {
                              var a = this._decoder.decodePushData(
                                this._pushType.LEAVE,
                                n.data
                              );
                              this._handleLeave(r, a);
                            } else if (s === this._pushType.UNSUBSCRIBE) {
                              var c = this._decoder.decodePushData(
                                this._pushType.UNSUBSCRIBE,
                                n.data
                              );
                              this._handleUnsub(r, c);
                            } else if (s === this._pushType.SUBSCRIBE) {
                              var h = this._decoder.decodePushData(
                                this._pushType.UNSUBSCRIBE,
                                n.data
                              );
                              this._handleSub(r, h);
                          ...
                          value: function (e, t, n) {
                            ...
                            ((this._callbacks[e] = {
                              ...
                              (this._callbacks[e].timeout = setTimeout(
                                function () {
                                  (delete s._callbacks[e],
                                    (0, o.isFunction)(n) &&
                                      n({ error: s._createErrorObject(f) }));
                                },
                          ...
                          value: function () {
                            ...
                            for (var s in t)
                              if (t.hasOwnProperty(s)) {
                                if (!this._getSub(s)) continue;
                                n.push(s);
                              }
                            if (0 !== n.length) {
                              var r = { client: this._clientID, channels: n },
                                i = this._clientID,
                                o = this._newXHRID(),
                                u = function (t) {
                                  if (
                                    ...
                                    if (t.error || 200 !== t.status) {
                                      ...
                                      var u = {};
                                      if (t.data.channels)
                                        for (var a in t.data.channels) {
                                          var c = t.data.channels[a];
                                          c.channel && (u[c.channel] = c.token);
                                        }
                                      var h = !1;
                                      for (var l in (e._isBatching ||
                                        (e.startBatching(), (h = !0)),
                                      n))
                                        if (n.hasOwnProperty(l)) {
                                          var f = (function () {
                                            ...
                                            var o = i._needRecover();
                                            if (!0 === o) {
                                              r.params.recover = !0;
                                              var a = e._getLastSeq(t),
                                                c = e._getLastGen(t);
                                              if (a || c)
                                                (a && (r.params.seq = a),
                                                  c && (r.params.gen = c));
                                              else {
                                                var h = e._getLastOffset(t);
                                                h && (r.params.offset = h);
                                              }
                                              var f = e._getLastEpoch(t);
                                              f && (r.params.epoch = f);
                                            }
                                            e._call(r).then(
                                              function (n) {
                              ...
                              if (null !== this._config.onPrivateSubscribe)
                                this._config.onPrivateSubscribe({ data: r }, u);
                              else {
                                var a = this._ajax(
                                  this._config.subscribeEndpoint,
                                  this._config.subscribeParams,
                        ...
                        },
                        {
                          key: "subscribe",
                          value: function (e, t, n) {
                            var s = this._getSub(e);
                            if (null !== s)
                              return (
                                s._setEvents(t),
                                s._isUnsubscribed() && s.subscribe(n),
                                s
                              );
                            var i = new r.default(this, e, t);
                            return ((this._subs[e] = i), i.subscribe(n), i);
                          },
                        },
                      ]),
                      s && c(t.prototype, s),
              ...
              471: function (e, t, n) {
                ...
                (Object.defineProperty(t, "__esModule", { value: !0 }),
                  (t.default = void 0));
                var r,
                  i = (r = n(187)) && r.__esModule ? r : { default: r },
                  o = n(853);
                function u(e, t) {
                  for (var n = 0; n < t.length; n++) {
                    var s = t[n];
                ...
                (Object.defineProperty(t, "__esModule", { value: !0 }),
                  (t.backoff = function (e, t, n) {
                    var s = 0.5 * Math.random(),
                      r = Math.min(n, t * Math.pow(2, e + 1));
                    return Math.floor((1 - s) * r);
                  }),
