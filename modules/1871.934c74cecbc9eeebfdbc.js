...
(self.webpackChunkfederation_modules =
  ...
  [1871],
  {
    1871: (e, t, n) => {
      ...
      const V = L.toFlatObject(L, {}, null, function (e) {
              ...
              return (
                ...
                a.forEach(function (e, r) {
                  !L.isUndefined(e) &&
                    null !== e &&
                    t.append(
                      !0 === i ? J([n], r, s) : null === i ? n : n + "[]",
                      c(e)
                    );
                }),
                !1
              );
          return !!M(e) || (t.append(J(o, n, s), c(e)), !1);
        }
        const l = [],
          f = Object.assign(V, {
            defaultVisitor: u,
        ...
        return (
          (function e(n, r) {
            if (!L.isUndefined(n)) {
              ...
              (l.push(n),
                L.forEach(n, function (n, s) {
                  !0 ===
                    (!(L.isUndefined(n) || null === n) &&
                      o.call(t, n, L.isString(s) ? s.trim() : s, r, f)) &&
                    e(n, r ? r.concat(s) : [s]);
                }),
                l.pop());
            }
        ...
        ne = function (e) {
          function t(e, n, r, o) {
            ...
            const i = Number.isFinite(+s),
              a = o >= e.length;
            return (
              (s = !s && L.isArray(r) ? r.length : s),
              a
                ? (L.hasOwnProp(r, s) ? (r[s] = [r[s], n]) : (r[s] = n), !i)
                : ((r[s] && L.isObject(r[s])) || (r[s] = []),
                  t(e, n, r[s], o) &&
                    L.isArray(r[s]) &&
                    (r[s] = (function (e) {
                      const t = {},
      ...
      (L.forEach(["delete", "get", "head"], function (e) {
        ...
        L.forEach(["post", "put", "patch"], function (e) {
          oe.headers[e] = L.merge(re);
        }));
      var se = oe;
      const ie = L.toObjectSet([
          "age",
          "authorization",
          "content-length",
          "content-type",
      ...
      function ue(e) {
        return !1 === e || null == e ? e : L.isArray(e) ? e.map(ue) : String(e);
      }
        ...
        normalize(e) {
          ...
          return (
            L.forEach(this, (r, o) => {
              ...
              if (s) return ((t[s] = ue(r)), void delete t[o]);
              const i = e
                ? (function (e) {
                    return e
                      .trim()
      ...
      L.inherits(me, z, { __CANCEL__: !0 });
      var ye = me,
        ge = te.isStandardBrowserEnv
          ? {
      ...
      var Ee = te.isStandardBrowserEnv
        ? (function () {
        ...
        return (
          ...
          ((e) => {
            ...
            for (
              let o = 0;
              o < t &&
              ((n = e[o]), !(r = L.isString(n) ? Oe[n.toLowerCase()] : n));
              o++
            );
            if (!r) {
              if (!1 === r)
      ...
      function Te(e, t) {
        ...
        const c = {
          ...
          responseEncoding: i,
          validateStatus: a,
          headers: (e, t) => o(Ae(e), Ae(t), !0),
        };
        return (
          L.forEach(Object.keys(Object.assign({}, e, t)), function (r) {
            const s = c[r] || o,
              i = s(e[r], t[r], r);
            (L.isUndefined(i) && s !== a) || (n[r] = i);
          }),
          n
        );
      }
      ...
      class je {
        ...
        request(e, t) {
          ...
          (void 0 !== n &&
            ...
            (s = o && L.merge(o.common, o[t.method])),
            s &&
              L.forEach(
      ...
      const De = (function e(t) {
        const n = new Pe(t),
          o = r(Pe.prototype.request, n);
        return (
          L.extend(o, Pe.prototype, n, { allOwnKeys: !0 }),
      ...
      ((De.Axios = Pe),
        ...
        (De.mergeConfig = Te),
        (De.AxiosHeaders = de),
        (De.formToJSON = (e) => ne(L.isHTMLForm(e) ? new FormData(e) : e)),
        (De.HttpStatusCode = Be),
        (De.default = De));
      var Le = De;
      const {
        Axios: ke,
