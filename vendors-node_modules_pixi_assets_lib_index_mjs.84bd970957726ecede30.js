...
(self.webpackChunkfederation_clients =
  ...
  {
    "./node_modules/@pixi/assets/lib/index.mjs": (e, t, s) => {
      s.d(t, {
        sP: () => X,
        UR: () => S,
        l2: () => c,
      ...
      var a = s("./node_modules/@pixi/core/lib/index.mjs");
      const r = {
        loader: a.Ag.LoadParser,
        resolver: a.Ag.ResolveParser,
        cache: a.Ag.CacheParser,
        detection: a.Ag.DetectionParser,
      };
      a.XO.handle(
        a.Ag.Asset,
        (e) => {
          ...
          Object.entries(r)
            .filter(([e]) => !!t[e])
            .forEach(([e, s]) =>
              a.XO.add(Object.assign(t[e], { extension: t[e].extension ?? s }))
            );
        },
        (e) => {
          const t = e.ref;
      ...
      function o(e, t) {
        const s = e.split("?")[0],
          r = a.Wp.path.extname(s).toLowerCase();
        return Array.isArray(t) ? t.includes(r) : r === t;
      }
      const n = (e, t, s = !1) => (
          Array.isArray(e) || (e = [e]),
          t ? e.map((e) => ("string" == typeof e || s ? t(e) : e)) : e
        ),
        c = new (class {
          constructor() {
            ((this._parsers = []),
          ...
          get(e) {
            ...
            return (
              t ||
                console.warn(
                  `[Assets] Asset id ${e} was not found in the Cache`
                ),
              t
            );
          }
          set(e, t) {
            ...
            for (let e = 0; e < this.parsers.length; e++) {
              const a = this.parsers[e];
              if (a.test(t)) {
                r = a.getCacheableAssets(s, t);
                break;
              }
            }
            r ||
            ...
            if (
              ...
              const e = t;
              s.forEach((t) => {
                (e.baseTexture !== a.gP.EMPTY.baseTexture &&
                  a.t5.addToCache(e.baseTexture, t),
                  a.gP.addToCache(e, t));
              });
            }
          }
      ...
      class l {
        ...
        _getLoadPromiseAndParser(e, t) {
          ...
          return (
            (s.promise = (async () => {
              ...
              ((a = await r.load(e, t, this)), (s.parser = r));
              for (let e = 0; e < this.parsers.length; e++) {
                const r = this.parsers[e];
                r.parse &&
                  r.parse &&
                  (await r.testParse?.(a, t, this)) &&
                  ((a = (await r.parse(a, t, this)) || a), (s.parser = r));
              }
              return a;
            })()),
            s
        ...
        async load(e, t) {
          ...
          const r = {},
            i = d(e),
            o = n(e, (e) => ({ alias: [e], src: e })),
            c = o.length,
            l = o.map(async (e) => {
              const i = a.Wp.path.toAbsolute(e.src);
              if (!r[e.src])
                try {
                  (this.promiseCache[i] ||
                    (this.promiseCache[i] = this._getLoadPromiseAndParser(
                      i,
                      e
                    )),
                    (r[e.src] = await this.promiseCache[i].promise),
                    t && t(++s / c));
                } catch (t) {
                  throw (
          ...
          return (await Promise.all(l), i ? r[o[0].src] : r);
        }
        async unload(e) {
          const t = n(e, (e) => ({ alias: [e], src: e })).map(async (e) => {
            const t = a.Wp.path.toAbsolute(e.src),
              s = this.promiseCache[t];
            if (s) {
              const a = await s.promise;
              (delete this.promiseCache[t], s.parser?.unload?.(a, e, this));
            }
          });
          await Promise.all(t);
        }
            ...
            (this._parserHash = this._parsers
              ...
              .reduce(
                (e, t) => (
                  e[t.name] &&
                    console.warn(
                      `[Assets] loadParser name conflict "${t.name}"`
                    ),
                  { ...e, [t.name]: t }
                ),
                {}
      ...
      const p = {
        extension: { type: a.Ag.LoadParser, priority: h.Low },
        name: "loadJson",
        test: (e) => A(e, "application/json") || o(e, ".json"),
        load: async (e) => await (await a.W0.ADAPTER.fetch(e)).json(),
      };
      a.XO.add(p);
      const u = {
        name: "loadTxt",
        extension: { type: a.Ag.LoadParser, priority: h.Low },
        test: (e) => A(e, "text/plain") || o(e, ".txt"),
        load: async (e) => await (await a.W0.ADAPTER.fetch(e)).text(),
      };
      a.XO.add(u);
      const f = [
          "normal",
        ...
        m = [".ttf", ".otf", ".woff", ".woff2"],
        g = ["font/ttf", "font/otf", "font/woff", "font/woff2"],
        y = /^(--|-?[A-Z_])[0-9A-Z_-]*$/i;
      function _(e) {
        const t = a.Wp.path.extname(e),
          s = a.Wp.path
            .basename(e, t)
            .replace(/(-|_)/g, " ")
            .toLowerCase()
      ...
      const w = /^[0-9A-Za-z%:/?#\[\]@!\$&'()\*\+,;=\-._~]*$/,
        v = {
          ...
          test: (e) => A(e, g) || o(e, m),
          async load(e, t) {
            const s = a.W0.ADAPTER.getFontFaceSet();
            if (s) {
              const a = [],
                i = t.data?.family ?? _(e),
                o = t.data?.weights?.filter((e) => f.includes(e)) ?? ["normal"],
                n = t.data ?? {};
              for (let t = 0; t < o.length; t++) {
                const c = o[t],
                  d = new FontFace(
                    i,
                    `url(${((r = e), w.test(r) ? r : encodeURI(r))})`,
                    { ...n, weight: c }
                  );
                (await d.load(), s.add(d), a.push(d));
              }
          ...
          unload(e) {
            (Array.isArray(e) ? e : [e]).forEach((e) =>
              a.W0.ADAPTER.getFontFaceSet().delete(e)
            );
          },
        };
      a.XO.add(v);
      ...
      P.revokeObjectURL = function () {
        b && (URL.revokeObjectURL(b), (b = null));
      };
      let B = null;
      class k {
        constructor() {
      ...
      const x = new (class {
          ...
          return (
            void 0 !== this._isImageBitmapSupported ||
              (this._isImageBitmapSupported = new Promise((e) => {
                const { worker: t } = new P();
                t.addEventListener("message", (s) => {
                  (t.terminate(), P.revokeObjectURL(), e(s.data));
                });
              })),
        ...
        async _run(e, t) {
          ...
          const s = new Promise((s, a) => {
            this.queue.push({ id: e, arguments: t, resolve: s, reject: a });
          });
          return (this.next(), s);
        }
        next() {
          ...
          const t = this.queue.pop(),
            s = t.id;
          ((this.resolveHash[O] = { resolve: t.resolve, reject: t.reject }),
            e.postMessage({ data: t.arguments, uuid: O++, id: s }));
        }
      })();
      function L(e, t, s) {
        ...
        const r = new a.gP(e),
          i = () => {
            (delete t.promiseCache[s], c.has(s) && c.remove(s));
          };
        return (
      ...
      const E = [".jpeg", ".jpg", ".png", ".webp", ".avif"],
        W = ["image/jpeg", "image/png", "image/webp", "image/avif"];
      async function R(e) {
        const t = await a.W0.ADAPTER.fetch(e);
        if (!t.ok)
          throw new Error(
      ...
      const j = {
        name: "loadTextures",
        extension: { type: a.Ag.LoadParser, priority: h.High },
        config: {
          preferWorkers: !0,
        ...
        async load(e, t, s) {
          ...
          let i;
          i = r
            ? this.config.preferWorkers && (await x.isImageBitmapSupported())
              ? await x.loadImageBitmap(e)
              : await R(e)
            : await new Promise((t, s) => {
                ...
                ((a.crossOrigin = this.config.crossOrigin),
                  ...
                  a.complete
                    ? t(a)
                    : ((a.onload = () => t(a)), (a.onerror = (e) => s(e))));
              });
          const o = { ...t.data };
          (o.resolution ?? (o.resolution = a.Wp.getResolutionOfUrl(e)),
            r &&
              void 0 === o.resourceOptions?.ownsImageBitmap &&
              ((o.resourceOptions = { ...o.resourceOptions }),
              (o.resourceOptions.ownsImageBitmap = !0)));
          const n = new a.t5(i, o);
          return ((n.resource.src = e), L(n, s, e));
        },
        unload(e) {
          e.destroy(!0);
        },
      ...
      const C = {
        extension: { type: a.Ag.LoadParser, priority: h.High },
        name: "loadSVG",
        test: (e) => A(e, "image/svg+xml") || o(e, ".svg"),
        testParse: async (e) => a.$f.test(e),
        async parse(e, t, s) {
          const r = new a.$f(e, t?.data?.resourceOptions);
          await r.load();
          const i = new a.t5(r, {
            resolution: a.Wp.getResolutionOfUrl(e),
            ...t?.data,
          });
          return ((i.resource.src = t.src), L(i, s, t.src));
        },
        load: async (e, t) => (await a.W0.ADAPTER.fetch(e)).text(),
        unload: j.unload,
      };
      a.XO.add(C);
      const F = [".mp4", ".m4v", ".webm", ".ogv"],
        T = ["video/mp4", "video/webm", "video/ogg"],
        $ = {
          name: "loadVideo",
          extension: { type: a.Ag.LoadParser, priority: h.High },
          config: {
          ...
          async load(e, t, s) {
            let r;
            const i = await (await a.W0.ADAPTER.fetch(e)).blob(),
            ...
            try {
              ...
              await n.load();
              const c = new a.t5(n, {
                alphaMode: await a.Wp.detectVideoAlphaMode(),
                resolution: a.Wp.getResolutionOfUrl(e),
                ...t?.data,
              });
              ((c.resource.src = e),
      ...
      function U(e, t, s, a, r) {
        ...
        for (let o = 0; o < i.length; o++) {
          const n = i[o];
          s < t.length - 1
            ? U(e.replace(a[s], n), t, s + 1, a, r)
            : r.push(e.replace(a[s], n));
        }
      }
      function M(e) {
        const t = e.match(/\{(.*?)\}/g),
      ...
      class D {
        ...
        getAlias(e) {
          const { alias: t, name: s, src: a, srcs: r } = e;
          return n(
            t || s || a || r,
            (e) =>
              "string" == typeof e
        ...
        addBundle(e, t) {
          ...
          (Array.isArray(t)
            ? t.forEach((t) => {
                const a = t.src ?? t.srcs,
                  r = t.alias ?? t.name;
                let i;
                if ("string" == typeof r) {
                  const t = this._createBundleAssetId(e, r);
                  (s.push(t), (i = [r, t]));
                } else {
                  const t = r.map((t) => this._createBundleAssetId(e, t));
                  (s.push(...t), (i = [...r, ...t]));
                }
                this.add({ ...t, alias: i, src: a });
              })
            : Object.keys(t).forEach((a) => {
                const r = [a, this._createBundleAssetId(e, a)];
                if ("string" == typeof t[a]) this.add({ alias: r, src: t[a] });
                else if (Array.isArray(t[a])) this.add({ alias: r, src: t[a] });
                else {
                  const e = t[a],
                    s = e.src ?? e.srcs;
                  this.add({ ...e, alias: r, src: Array.isArray(s) ? s : [s] });
                }
                s.push(...r);
              }),
            (this._bundles[e] = s));
        ...
        add(e, t, s, r, i) {
          ...
          ("string" == typeof e || (Array.isArray(e) && "string" == typeof e[0])
            ? (a.Wp.deprecation(
              ...
              o.push({ alias: e, src: t, data: s, format: r, loadParser: i }))
            : Array.isArray(e)
              ? o.push(...e)
              : o.push(e),
            (c = (e) => {
            ...
            n(o).forEach((e) => {
              const { src: t, srcs: s } = e;
              let { data: a, format: r, loadParser: i } = e;
              const o = n(t || s).map((e) =>
                  "string" == typeof e ? M(e) : Array.isArray(e) ? e : [e]
                ),
                d = this.getAlias(e);
              Array.isArray(d) ? d.forEach(c) : c(d);
              const l = [];
              (o.forEach((e) => {
                e.forEach((e) => {
                  let t = {};
          ...
          return (
            e.forEach((e) => {
              ...
              if (t) {
                ...
                for (const t in a) {
                  const s = a[t];
                  r[this._extractAssetIdFromBundle(e, t)] = s;
                }
                s[e] = r;
              }
            }),
            ...
            e.forEach((e) => {
              if (!this._resolverHash[e])
                if (this._assetMap[e]) {
                  ...
                  const s = t[0],
                    a = this._getPreferredOrder(t);
                  (a?.priority.forEach((e) => {
                    a.params[e].forEach((s) => {
                      const a = t.filter((t) => !!t[e] && t[e] === s);
                      a.length && (t = a);
                    });
                  }),
                    (this._resolverHash[e] = t[0] ?? s));
                } else
                  this._resolverHash[e] = this.buildResolvedAsset(
                    { alias: [e], src: e },
                    {}
                  );
              s[e] = this._resolverHash[e];
            }),
            t ? s[e[0]] : s
          );
        }
        ...
        _appendDefaultSearchParams(e) {
          return this._defaultSearchParams
            ? `${e}${/\?/.test(e) ? "&" : "?"}${this._defaultSearchParams}`
            : e;
        }
        buildResolvedAsset(e, t) {
          const { aliases: s, data: r, loadParser: i, format: o } = t;
          return (
            (this._basePath || this._rootPath) &&
              (e.src = a.Wp.path.toAbsolute(
                e.src,
                this._basePath,
                this._rootPath
              )),
            ...
            (e.format = o ?? e.format ?? a.Wp.path.extname(e.src).slice(1)),
            (e.srcs = e.src),
            (e.name = e.alias),
            e
          );
      ...
      class S {
        constructor() {
          ((this._detections = []),
            ...
            (this.loader = new l()),
            (this.cache = c),
            (this._backgroundLoader = new i(this.loader)),
        ...
        async load(e, t) {
          ...
          const s = d(e),
            a = n(e).map((e) => {
              ...
              return (
                this.resolver.hasKey(e) || this.add({ alias: e, src: e }),
                e
              );
            }),
            r = this.resolver.resolve(a),
            i = await this._mapLoadToResolve(r, t);
          return s ? i[a[0]] : i;
        }
        addBundle(e, t) {
        ...
        async loadBundle(e, t) {
          this._initialized || (await this.init());
          let s = !1;
          "string" == typeof e && ((s = !0), (e = [e]));
          const a = this.resolver.resolveBundle(e),
            r = {},
            i = Object.keys(a);
          let o = 0,
            n = 0;
          const c = () => {
            ...
            d = i.map((e) => {
              ...
              return (
                ...
                this._mapLoadToResolve(t, c).then((t) => {
                  r[e] = t;
                })
              );
            });
          return (await Promise.all(d), s ? r[e[0]] : r);
        }
        ...
        get(e) {
          ...
          const t = {};
          for (let s = 0; s < e.length; s++) t[s] = c.get(e[s]);
          return t;
        }
        async _mapLoadToResolve(e, t) {
          ...
          return (
            s.forEach((e, t) => {
              const s = r[e.src],
                o = [e.src];
              (e.alias && o.push(...e.alias), (i[a[t]] = s), c.set(o, s));
            }),
            i
          );
        }
        async unload(e) {
          this._initialized || (await this.init());
          const t = n(e).map((e) => ("string" != typeof e ? e.src : e)),
            s = this.resolver.resolve(t);
          await this._unloadFromResolved(s);
        }
        async unloadBundle(e) {
          (this._initialized || (await this.init()), (e = n(e)));
          const t = this.resolver.resolveBundle(e),
            s = Object.keys(t).map((e) => this._unloadFromResolved(t[e]));
          await Promise.all(s);
        }
        ...
        async _detectFormats(e) {
          ...
          return ((t = t.filter((e, s) => t.indexOf(e) === s)), t);
        }
        get detections() {
          return this._detections;
        }
        get preferWorkers() {
          return j.config.preferWorkers;
        }
        set preferWorkers(e) {
          (a.Wp.deprecation(
            "7.2.0",
      ...
      const X = new S();
      a.XO.handleByList(a.Ag.LoadParser, X.loader.parsers)
        .handleByList(a.Ag.ResolveParser, X.resolver.parsers)
        .handleByList(a.Ag.CacheParser, X.cache.parsers)
        .handleByList(a.Ag.DetectionParser, X.detections);
      const H = {
        extension: a.Ag.CacheParser,
        test: (e) => Array.isArray(e) && e.every((e) => e instanceof a.gP),
      ...
      a.XO.add(H);
      const z = {
        extension: { type: a.Ag.DetectionParser, priority: 1 },
        test: async () =>
          G(
      ...
      a.XO.add(z);
      const V = {
        extension: { type: a.Ag.DetectionParser, priority: 0 },
        test: async () =>
          G(
      ...
      a.XO.add(V);
      const Q = ["png", "jpg", "jpeg"],
        K = {
          extension: { type: a.Ag.DetectionParser, priority: -1 },
          test: () => Promise.resolve(!0),
          add: async (e) => [...e, ...Q],
          remove: async (e) => e.filter((e) => !Q.includes(e)),
        };
      a.XO.add(K);
      const Y =
      ...
      function Z(e) {
        return !Y && "" !== document.createElement("video").canPlayType(e);
      }
      const N = {
        extension: { type: a.Ag.DetectionParser, priority: 0 },
        test: async () => Z("video/webm"),
        add: async (e) => [...e, "webm"],
      ...
      const J = {
        extension: { type: a.Ag.DetectionParser, priority: 0 },
        test: async () => Z("video/ogg"),
        add: async (e) => [...e, "ogv"],
        remove: async (e) => e.filter((e) => "ogv" !== e),
      };
      a.XO.add(J);
      const ee = {
        extension: a.Ag.ResolveParser,
        test: j.test,
        parse: (e) => ({
          resolution: parseFloat(a.W0.RETINA_PREFIX.exec(e)?.[1] ?? "1"),
          format: a.Wp.path.extname(e).slice(1),
          src: e,
        }),
      };
      a.XO.add(ee);
