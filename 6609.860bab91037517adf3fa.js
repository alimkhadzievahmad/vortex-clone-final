...
(self.webpackChunkfederation_modules =
  ...
  [6609],
  {
    6609: (t, e, s) => {
      ...
      function h(t, e, s) {
        const { obj: i, k: n } = u(t, e, Object);
        i[n] = s;
      }
      function c(t, e) {
        const { obj: s, k: i } = u(t, e);
        if (s) return s[i];
      }
      function p(t, e, s) {
        for (const i in e)
      ...
      function f(t) {
        return "string" == typeof t ? t.replace(/[&<>"'\/]/g, (t) => d[t]) : t;
      }
      const m = [" ", ",", "?", "!", ";"];
      function y(t, e) {
        let s =
        ...
        for (let t = 0; t < i.length; ++t) {
          ...
          if (void 0 === n[i[t]]) {
            let o = 2,
              r = i.slice(t, t + o).join(s),
              a = n[r];
            for (; void 0 === a && i.length > t + o; )
              (o++, (r = i.slice(t, t + o).join(s)), (a = n[r]));
            if (void 0 === a) return;
      ...
      class b extends r {
        ...
        getResource(t, e, s) {
          ...
          let r = [t, e];
          (s && "string" != typeof s && (r = r.concat(s)),
            s && "string" == typeof s && (r = r.concat(n ? s.split(n) : s)),
            t.indexOf(".") > -1 && (r = t.split(".")));
          const a = c(this.data, r);
          return a || !o || "string" != typeof s
            ? a
            : y(this.data && this.data[t] && this.data[t][e], s, n);
        }
        addResource(t, e, s, i) {
          let n =
        ...
        addResources(t, e, s) {
          ...
          for (const i in s)
            ("string" != typeof s[i] &&
              "[object Array]" !== Object.prototype.toString.apply(s[i])) ||
      ...
      var x = {
        ...
        handle(t, e, s, i, n) {
          return (
            t.forEach((t) => {
              this.processors[t] &&
                (e = this.processors[t].process(e, s, i, n));
            }),
            e
          );
        },
      ...
      class k extends r {
        ...
        extractFromKey(t, e) {
          ...
          const o = s && t.indexOf(s) > -1,
            r = !(
              ...
              (function (t, e, s) {
                ((e = e || ""), (s = s || ""));
                const i = m.filter((t) => e.indexOf(t) < 0 && s.indexOf(t) < 0);
        ...
        translate(t, e, s) {
          ...
          if (l && "cimode" === l.toLowerCase()) {
            ...
            return i
              ? { res: o, usedKey: o, exactUsedKey: o, usedLng: l, usedNS: a }
              : o;
          }
          const h = this.resolve(t, e);
          let c = h && h.res;
          const p = (h && h.usedKey) || o,
            g = (h && h.exactUsedKey) || o,
            d = Object.prototype.toString.apply(c),
            f =
          ...
          if (
            ...
            if (!e.returnObjects && !this.options.returnObjects) {
              ...
              const t = this.options.returnedObjectHandler
                ? this.options.returnedObjectHandler(p, c, { ...e, ns: r })
                : `key '${o} (${this.language})' returned an object instead of string.`;
              return i ? ((h.res = t), h) : t;
            }
            if (n) {
          ...
          } else if (m && "string" == typeof f && "[object Array]" === d)
            ((c = c.join(f)), c && (c = this.extendTranslation(c, t, e, s)));
          else {
            let i = !1,
              r = !1;
            const u = void 0 !== e.count && "string" != typeof e.count,
              p = k.hasDefaultValue(e),
              ...
              f =
                ...
                e[`defaultValue${d}`] ||
                e.defaultValue;
            (!this.isValidLookup(c) && p && ((i = !0), (c = f)),
              this.isValidLookup(c) || ((r = !0), (c = o)));
            const m =
            ...
            if (r || i || y) {
              ...
              const i = (t, s, i) => {
                ...
                (this.options.missingKeyHandler
                  ? this.options.missingKeyHandler(t, a, s, n, y, e)
                  : this.backendConnector &&
                    this.backendConnector.saveMissing &&
                    this.backendConnector.saveMissing(t, a, s, n, y, e),
                  this.emit("missingKey", t, a, s, c));
              };
            ...
            ((c = this.extendTranslation(c, t, e, h, s)),
              r &&
                c === o &&
        ...
        extendTranslation(t, e, s, i, n) {
          ...
          if (this.i18nFormat && this.i18nFormat.parse)
            ...
            const r =
              ...
              (s &&
              s.interpolation &&
              void 0 !== s.interpolation.skipOnVariables
                      ...
                      if (
                        (h &&
                          ...
                          r.ordinal &&
                            0 === t.indexOf(i) &&
                            o.push(
                              l + t.replace(i, this.options.pluralSeparator)
                            ),
                          c && o.push(l + e)),
                        p)
                      ) {
      ...
      class w {
        ...
        getScriptPartFromCode(t) {
          if (!(t = v(t)) || t.indexOf("-") < 0) return null;
          const e = t.split("-");
          return 2 === e.length
            ? null
            : (e.pop(),
      ...
      const R = ["v1", "v2", "v3"],
        $ = ["v4"],
        C = { zero: 0, one: 1, two: 2, few: 3, many: 4, other: 5 };
      class P {
        constructor(t) {
          let e =
            arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
          ((this.languageUtils = t),
            ...
            (this.rules = (function () {
              ...
              return (
                O.forEach((e) => {
                  e.lngs.forEach((s) => {
                    t[s] = { numbers: e.nr, plurals: N[e.fc] };
                  });
                }),
                t
              );
        ...
        getRule(t) {
          ...
          if (this.shouldUseIntlApi())
            try {
              return new Intl.PluralRules(v(t), {
        ...
        getSuffixes(t) {
          ...
          return s
            ? this.shouldUseIntlApi()
              ? s
                  .resolvedOptions()
                  .pluralCategories.sort((t, e) => C[t] - C[e])
                  .map(
                    (t) =>
      ...
      function j(t, e, s) {
        let i =
          ...
          o = (function (t, e, s) {
            const i = c(t, s);
            return void 0 !== i ? i : c(e, s);
          })(t, e, s);
        return (
          !o &&
            n &&
            "string" == typeof s &&
            ((o = y(t, s, i)), void 0 === o && (o = y(e, s, i))),
          o
        );
      }
      class E {
        ...
        init() {
          ...
          ((this.escape = void 0 !== e.escape ? e.escape : f),
            ...
            (this.prefix = e.prefix ? g(e.prefix) : e.prefixEscaped || "{{"),
            (this.suffix = e.suffix ? g(e.suffix) : e.suffixEscaped || "}}"),
            ...
            (this.nestingPrefix = e.nestingPrefix
              ? g(e.nestingPrefix)
              : e.nestingPrefixEscaped || g("$t(")),
            (this.nestingSuffix = e.nestingSuffix
              ? g(e.nestingSuffix)
              : e.nestingSuffixEscaped || g(")")),
                  ...
                  : "relativetime" === e && n.indexOf(":") < 0
                    ...
                    : n.split(";").forEach((t) => {
                        ...
                        (s[e.trim()] || (s[e.trim()] = n),
                          "false" === n && (s[e.trim()] = !1),
                          "true" === n && (s[e.trim()] = !0),
                          isNaN(n) || (s[e.trim()] = parseInt(n, 10)));
                      });
              }
      ...
      class T extends r {
        ...
        loaded(t, e, s) {
          ...
          (e && this.emit("failedLoading", n, o, e),
            s && this.store.addResourceBundle(n, o, s),
            (this.state[t] = e ? -1 : 2));
          const r = {};
          (this.queue.forEach((s) => {
            (!(function (t, e, s, i) {
              const { obj: n, k: o } = u(t, e, Object);
              ((n[o] = n[o] || []), n[o].push(s));
            })(s.loaded, [n], o),
              (function (t, e) {
                void 0 !== t.pending[e] &&
          ...
          this.read(i, n, "read", void 0, void 0, (s, o) => {
            (s &&
              ...
              !s &&
                o &&
                this.logger.log(
                  `${e}loaded namespace ${n} for language ${i}`,
                  o
                ),
              this.loaded(t, s, o));
          });
      ...
      class U extends r {
        constructor() {
          ...
          if (
            ...
            (s = this),
            Object.getOwnPropertyNames(Object.getPrototypeOf(s)).forEach(
              (t) => {
                "function" == typeof s[t] && (s[t] = s[t].bind(s));
              }
            ),
        ...
        init() {
          ...
          if (
            ((this.options = { ...i, ...this.options, ...A(e) }),
            "v1" !== this.options.compatibilityAPI &&
              (this.options.interpolation = {
                ...i.interpolation,
                ...this.options.interpolation,
            ...
            ((r.logger = o),
              ...
              (r.interpolator = new E(this.options)),
              (r.utils = {
                hasLoadedNamespace: this.hasLoadedNamespace.bind(this),
              }),
              (r.backendConnector = new T(
              ...
              this.modules.i18nFormat &&
                ((r.i18nFormat = n(this.modules.i18nFormat)),
        ...
        loadResources(t) {
          ...
          if (
            ...
            if (s && "cimode" === s.toLowerCase()) return e();
            const t = [],
              i = (e) => {
                e &&
        ...
        use(t) {
          ...
          return (
            ...
            "postProcessor" === t.type && x.addPostProcessor(t),
        ...
        dir(t) {
          if (
            ...
            return "rtl";
          const e =
            (this.services && this.services.languageUtils) || new w(V());
          return [
            "ar",
            "shu",
            "sqr",
        ...
        cloneInstance() {
          ...
          return (
            ...
            s &&
              ((n.store = new b(this.store.data, i)),
              (n.services.resourceStore = n.store)),
            (n.translator = new k(n.services, i)),
      ...
      const K = U.createInstance();
      K.createInstance = U.createInstance;
      const M = K.createInstance,
        H = K.dir,
        B = K.init,
        J = K.loadResources,
        z = K.reloadResources,
        ...
        Y = K.t,
        G = K.exists,
        Q = K.setDefaultNamespace,
        X = K.hasLoadedNamespace,
        Z = K.loadNamespaces,
        tt = K.loadLanguages;
    },
  },
